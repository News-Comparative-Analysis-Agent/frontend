...
const LoginPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden py-12 bg-background font-sans text-left">
      {/* 배경 장식 (모달의 블러 느낌과 페이지의 그리드 조합) */}
      ...
      <main className="relative z-10 w-full max-w-[440px] px-6 animate-in fade-in zoom-in-95 duration-500">
        <div className="bg-white rounded-[40px] shadow-[0_32px_64px_-16px_rgba(0,0,0,0.1)] border border-slate-100 p-10 md:p-12">
